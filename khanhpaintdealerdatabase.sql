...
-- 2. ProductLines (Dòng sản phẩm - Đã tích hợp các thông số kỹ thuật)
...
-- 3. BaseTypes (Danh mục Cốt sơn - Đã tối giản)
...
-- 6. ColorSystem_Colorants (Công thức pha màu)
...
-- 7. ProductVariants (Sản phẩm cụ thể - Liên kết Line và Base)
...
-- 12. Employees_Shifts (Phân ca nhân viên)
